<br/><br/>
<p>Consulta por letra inicial del Nombre</p>
<?php
//Se crea un array con el abcdario
$letra = array('A','B','C','D','E','F','G','H','I','J','K','L','M','N','Ñ','O','P','Q','R','S','T','U','V','W','X','Y','Z');

//Con un for se muestra en pantalla todo el abcdario, se construye un enlace dinámico por cada letra del abcdario
